...
public:
	...
	ComPtr<ID3D11Buffer> CreateAppendConsumeStructuredBuffer(const void* initBufferData, unsigned int elementSize, unsigned int elementCount, bool cpuWrite, bool dynamic);
